...
BDOBB is designed around multiple simultaneous backends — a general OpenBB Platform backend, a [[news-ticker|news ticker]], a [[live-quotes|live quotes]] service, and an [[ai-chat|AI agent]] can all be connected at once, each contributing its own widgets and dashboards to the same app.
