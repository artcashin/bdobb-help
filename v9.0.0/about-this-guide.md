...
| Ep. 10–12 plan — "the chart, the vault, the wire to the Street" (design doc, approved 2026-08-06; not yet implemented) | Planned: a real-time chart widget (Ep. 10) and an ArcticDB data explorer (Ep. 11). Also documents the optional kdb+ cache layer already shipped in openbb-docker v10.0.0. | [[real-time-chart\|Real-Time Chart (Planned)]], [[arcticdb-explorer\|ArcticDB Explorer (Planned)]], [[kdb-cache\|kdb+ Cache (Optional)]] |
