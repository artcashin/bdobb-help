...
BDOBB has no data of its own — every widget and dashboard comes from a backend you've connected by URL. This page is the reference for what "API key" means for each backend type, since it isn't the same thing twice.
